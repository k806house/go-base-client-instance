    ...
    <Wrapper>
      ...
      <Content>
        <Text>
          ...
          <a href="http://server.mindgamehack.ru/api/doc">http://server.mindgamehack.ru/api/doc</a>
          <p style={{marginBottom: 15}}></p>
...
`}</pre>
          ...
          player: {
          avatar: "http://server.mindgamehack.ru/uploads/608870de90735.png"
          nickname: "Dock"
...
`}
          ...
          <p></p>
          <img src="http://server.mindgamehack.ru/uploads/summ.png" alt={"sum"}/>
          <ol>
